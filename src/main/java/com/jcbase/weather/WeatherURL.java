...
class WeatherURL {
    ...
    private String TIANQI_API_SECRET_KEY = "nuwtrodpnjudgfk7"; //

    private String TIANQI_API_USER_ID = "UCB2351607"; //
    ...
    public static void main(String args[]){
    	WeatherURL demo = new WeatherURL();
        try {
