...
import com.yanxin.common.model.Warnimages;
...
public class _MappingKit {
	...
	public static void mapping(ActiveRecordPlugin arp) {
		...
		arp.addMapping("push_token", "id", PushToken.class);
		arp.addMapping("hw_push_station", "id", HwPushStation.class);
		arp.addMapping("hw_push_station_ywb", "id", HwPushStationYwb.class);
		arp.addMapping("config_push_log", "id", ConfigPushLog.class);
		arp.addMapping("update_app", "id", UpdateApp.class);
		
		arp.addMapping("work_area", "id", WorkArea.class);
	}
}
