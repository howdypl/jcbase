...
public class _CodeGenerator {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.jcbase.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = "/Users/yulong/remote/jcbase/src/main/java/com/jcbase/model/base";
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.jcbase.model";
