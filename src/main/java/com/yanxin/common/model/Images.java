...
public class Images extends BaseImages<Images> {
	...
	public Page<Images> getImagesPagev2(int page, int rows, String op_class, String station, String building, String sensor,String createTimeString, String endTimeString,
			String orderbyStr) {
		StringBuffer sqlExceptSelect=new StringBuffer();
	...
	public Page<Images> getImagesPagev3(int page, int rows, String op_class, String station, String building, String sensor,String createTimeString, String endTimeString,
			String orderbyStr) {
		StringBuffer sqlExceptSelect=new StringBuffer();
		...
		Page<Images> gallerys = this.paginate(page, rows, select, sqlExceptSelect.toString());
		...
		if(gallerys!=null){
			...
			for(Images rr:gallerys.getList()){
