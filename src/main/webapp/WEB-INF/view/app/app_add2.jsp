...
/* 	$(document).ready(function () {
		...
		jQuery(function($) {
			...
			<%-- $('#file_upload').uploadify({
				...
				'uploader' : '${context_path}/app/uploadApk;jsessionid=<%=session.getId()%>', //指定服务器端上传处理文件，默认‘upload.php’
				'auto' : true, //手动上传
			...
			$('#validation-form').validate({
				...
				submitHandler : function(form) {
					...
					/* $.post('${context_path}/app/saveApp2', $form.serialize(), function(data) {
						$btn.removeClass("disabled");
						if (data.code == 0) {
							window.parent.reloadGrid(); //重新载入
							layer.msg("保存成功", {
