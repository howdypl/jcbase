                ...
                <div class="box-content">
                    <div class="row" style="margin-left: 15px">
						...
						<div class="row" style="margin-left: 15px">
							...
							<div class="col-md-3" style="width: 16%">
								<button type="button" id="btn" value="0" class="btn btn-success btn-lg" style="margin-left: 300px; margin-top: -10px;">一键全拍</button>
							</div>
							<!-- <div class="col-md-3" style="width: 16%">
			    ...
			    success: function(data) {
		            ...
		            if (result == true) { //成功添加
		                 ...
		                 $.each(imageList, function(i,value){		  
 		                    $('#myquerygallery').append("<li id='"+value.id+"' class='thumbnail'><a href='/warndetil' class='gallery' style='width: auto;' > <img style='width: 200px;' class='gallery' src='<%=baseImagePath%>"+value.images+"'></a><div style='font-size: 20px;margin: 10px;float: left;'>"+value.maxTemp+"</div><div style='float: left;'>"+value.station_name+"/"+value.name+"/"+value.platform_code+"</div> <div>"+value.create_time+"</div></li>");
