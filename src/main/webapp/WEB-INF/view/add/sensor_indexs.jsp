...
<html lang="en">
	...
	<script src="${res_url}jsto/dateFormat.js"></script>
	<body class="no-skin">
							...
							<div class="col-xs-12">
									...
									<div class="widget-box">
											...
											<div class="row" style="margin-top:5px;">
												...
												<div class="col-md-2" style="width: 16%;margin-left:5px;margin-top:5px;margin-bottom:5px;">
													<select id="warn_status" onchange="typeSelect(this)" class="form-control selectpicker" >
	...
	function command(){
		...
		$(window).on('resize.jqGrid', function () {
           ...
           $("#grid-table").jqGrid({
               ...
               colModel: [
                   ...
                   { label: '运行时间', name: 'update_time', formatter:fmatterUpdateTime, width: 70 },
                   { label: '状态更新时间', name: 'create_time', width: 90,sortable:true },
               ],
			viewrecords: true,
               height: 350,
               rowNum: 10,
        ...
        //格式化状态显示
 		function fmatterStatus(cellvalue, options, rowObject){
 			if(cellvalue==0){
 				return '<span class="label label-sm label-warning">失联</span>';
 			}else{
 		...
 		function fmatterUpdateTime(cellvalue, options, rowObject){
 			if(cellvalue!=null){
 				var d = new Date(Date.parse(cellvalue.replace(/-/g, "/")));
 				var current = new Date();
 				var hours = getInervalHour(d,current);
 				return '<span class="label label-important">'+hours+'小时</span>';
 			}
