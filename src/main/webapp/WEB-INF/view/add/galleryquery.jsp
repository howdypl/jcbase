        ...
        <div class="box col-md-12">
            <div class="box-inner" style="overflow:hidden">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-search"></i> 图像详情</h2>
					    	...
					    	if(value.url!=null){
					     	...
					     	$(tempa).on("click",function(e){
					     		...
					     		parent.layer.open({
								    ...
								    shadeClose: true,
								    area: ['700px','600px'],
								    content: '${context_path}/galleryquery/openGallery?id='+value.id+'&sensor_code='+value.im_sensor_code+'&create_time='+value.create_time+'&point_type='+value.point_type   
								});
		                 ...
		                 $.each(imageList, function(i,value){
					    	...
					    	if(value.url!=null){
					     	...
					     	temp.appendChild(tempa);					     						     	
					      	...
					      	div1.innerHTML = value.max+"℃";
					     	div1.style.cssText +='font-size: 20px;margin-top: 5px;float: left;'
					     	if(value.warn_temp<=value.max){
					     		div1.style.cssText += 'color:red;';
					     	}else {
					     		div1.style.cssText += 'color:blue;';
					     	}
					     	
					     	var div2=document.createElement("div");
				      		//div2.innerHTML = value.station_name+"-"+value.building_name;
				     		
				     		div2.innerHTML = value.create_time+"<br>"+value.station_name+"-"+value.sensor_name;
					     	...
					     	tempimg.src= paths;
					     	tempimg.className="gallery";
					     	tempimg.style.cssText +='width: auto;';
					     	tempa.appendChild(tempimg);
