...
<head>
    ...
    <link href='${res_url}first/bower_components/bootstrap/dist/css/bootstrap.min.css' rel='stylesheet'> 
    <link href='${res_url}first/bower_components/bootstrap/dist/css/bootstrap-theme.min.css' rel='stylesheet'> 
