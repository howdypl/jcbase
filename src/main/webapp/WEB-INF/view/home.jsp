...
<jsp:include page="/WEB-INF/view/add/common/header.jsp" flush="true" />
    <div class="row">
		...
		<div class="box col-md-12" style="width:100%;;height:auto;margin:0 0 0 0;">
			<!-- <div class="guangzipaibox1">
				    <ul id="temp_pad">
				    </ul>
				</div> -->
			<div class="box-inner" style="height:auto;padding-bottom:0px;">
				<div class="box-header well" style="height:auto; margin:3px;">
					<h2>
				...
				<div class="box-content" class="table-responsive" >
					...
					<div>
						...
						<div id="myTabContent" class="tab-content guangzipaibox1">
			...
			<div class="box col-md-12" style="width:100%;margin:0 0 0 0;">
	            <div class="box-inner" >
	                <div class="box-header well" style="height:auto; margin:2px;">
	                ...
	                <div class="box-content" style="height:300px;">
	                	 <div id="container" style="width: 50%; height:100%;margin: 0 auto; float: left;">
	                	 	<div style='text-align:center'><span id='process_histogram' class='availability_status' > </span></div>
	                	 
	                	 </div>
	                	 <div id="container1" style="width: 50%; height:100%;margin: 0 auto;float: left;">
			...
			<div class="box col-md-12" >
				<div class="box-inner" style="overflow:hidden">
					<div class="box-header well" style="margin:2px;">
						<h2>
					...
					<div class="box-content" style="height:100%;">
						...
						<div class="wdpicbox1">
							<ul id="myquerygallery" style="width:105%;">
							</ul>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		work_area_default = "${sessionScope.sysUser.work_area_id}";
		operation_class_default = "${sessionScope.sysUser.operation_class_id}";
	 ...
	 $.ajax({
		    ...
		    success: function(data) {
	            ...
	            if (result == 0) { //成功添加  
	            	...
	            	document.getElementById("today_max_temp").innerHTML=statics.today_max_temp+"℃";
	            	document.getElementById("today_min_temp").innerHTML=statics.today_min_temp+"℃";
	            	document.getElementById("yesterday_max_temp").innerHTML=statics.yesterday_max_temp+"℃";
	            	document.getElementById("month_max_temp").innerHTML=statics.month_max_temp+"℃";
	            	...
	            	/*  $('#add_lie').append('<th>站名</th>');
            		 ...
            		 var myUL = document.getElementById("temp_pad");
	            	  $.each(imageList, function(i,value){
	            	  	...
	            	  	gzpdownbox1SPAN.innerHTML=value.temper+"℃";
 ...
 * 得到各站的告警状态:光字牌
 */
function getWarnNumber2(elID){
	var name="${sessionScope.sysUser.name}";
	var which = document.getElementById(elID);
	which.innerHTML="";
	 $.ajax({
		    type: 'POST',
		    dataType: 'json',
		    ...
		    success: function(data) {
	            ...
	            if (result == true) { //成功添加             
	            	/*  $('#add_lie').append('<th>站名</th>');
	            	 $('#add_number').append('<td>告警</td>');
            		 $('#add_temp').append('<td>温度</td>'); */
            		 var myUL = document.getElementById(elID);
	            	  $.each(imageList, function(i,value){
	            	  	var myLI = document.createElement('li');
	            	  	myUL.appendChild(myLI);
	            	  	...
	            	  	var gzpdownbox1P = document.createElement('p');
	            	  	gzpdownbox1P.innerHTML='当前';//myaddress;
	            	  	gzpdownbox1.appendChild(gzpdownbox1P);
		    ...
		    success: function(data) {
	            ...
	            if (result == true) { //成功添加
	                 ...
	                 $.each(imageList, function(i,value){
					    ...
					    wdpicdowntxt1P.innerHTML = value.max+"℃";
		    ...
		    success: function(data) {
	            ...
	            if (result == true) { //成功添加
	            	  $.each(tempList, function(i,value){	
	            		  var name=value.station_name+"#"+value.name+"("+value.platform_code+")"+"<br>"+value.history_time;
	            		  maxTemp.push(value.history_max_temp);
	            	  ...
	            	  var chart = {
	            		   ...
	            		   var tooltip = {
	            		      ...
	            		      pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name}: </td>' +
	            		         ...
	            		         '<td style="padding:0"><b>{point.z}</b></td></tr>',
	            		      footerFormat: '</table>',
	            		      shared: true,
	            		      useHTML: true,
	            		       formatter : function (){
...
/*得到当前变电站每个设备的折线图*/
 function getSensorTemp(){
	...
	function getWorkArea(){
		var which3 = document.getElementById('myTab');
		var which4 = document.getElementById('myTabContent');
					 ...
					 if(csize===1){
					    ...
					    getOperationClass2(work_area_default);
					 	...
					 	$.each(content, function(i,value){
				     		...
				     		if(i==0){
					 			work_area_default = value.id;
					 			iLI.className="active";
					 		}
				     		
				     		iLI.dataset['id'] = value.id;
				     		
	                     	which3.appendChild(iLI);
	                     	
	                     	var pointa = document.createElement("a");
	                     	pointa.innerHTML=value.area;
	                     	pointa.href= '#b'+value.id;
				     		//pointa.url = "${context_path}/warndetil?area="+value.work_area_id+"&opID="+value.opID+"&stationID="+value.stationID+"&buildingID="+value.buildingID+"&sensor_code="+value.pp_sensor_code+"&point_type="+value.point_type;
				     		pointa.dataset['id'] = value.id;
				     		pointa.dataset['toggle'] = 'tab';
				     		iLI.appendChild(pointa);
	                     	...
	                     	if(i==0){
	                     		cDIV.className="tab-pane fade in active";
	                     	}else{
	                     		cDIV.className="tab-pane fade in";
	                     	}
	                     	cDIV.id='#b'+value.id;
	                     	which4.appendChild(cDIV);
	                     	
	                     	var cUL = document.createElement("ul");
	                     	cUL.id='temp_pad'+value.id;
	                     	cDIV.appendChild(cUL);
	                     	if(i==0){
	                     		var t = "temp_pad"+value.id;
	                     		getWarnNumber2(t);
	                     	}
					    ...
					    $("#myTab").on("click","a",function(e){
							e.preventDefault();
							$("#myTab").find("li").attr("class","");
							$('#myTabContent').find("div").attr("class","tab-pane fade in ");
							
							$(this).parent('li').attr("class","active");
							var t = "temp_pad"+work_area_default;
							var tt = '#'+t;
							$(tt).parent("div").attr("class","tab-pane fade in active");
							work_area_default = $(this).data('id');
					...
					if(notEmpty){
					    ...
					    $.each(result, function(i,value){
					    	var iLI = document.createElement("li");
	                     	...
	                     	var pointa = document.createElement("a");
	                     	pointa.innerHTML=value.op_name;
	                     	pointa.href= '#b'+value.id;
				     		//pointa.url = "${context_path}/warndetil?area="+value.work_area_id+"&opID="+value.opID+"&stationID="+value.stationID+"&buildingID="+value.buildingID+"&sensor_code="+value.pp_sensor_code+"&point_type="+value.point_type;
				     		pointa.dataset['id'] = value.id;
				     		pointa.dataset['toggle'] = 'tab';
					    ...
					    $("#myTab").on("click","a",function(e){
								...
								$(this).parent('li').attr("class","active");
								var t = "temp_pad"+operation_class_default;
								var tt = '#'+t;
								$(tt).parent("div").attr("class","tab-pane fade in active");
